...
public class v2_MOBI_social_authorization {
    ...
    void socialGoogleAuthMobile() {
        ...
        Telegram.send("🚀 *Тест v2_MOBI_social_authorization* стартовал\n(вход через Google + SMS)", botToken, chatId);

        String email = creds.getProperty("google.email");
        String password = creds.getProperty("google.password");
        ...
        // --- Ожидание попапа ---
        System.out.println("Ждём окно авторизации Google...");
        ...
        popup.waitForClose(() -> {});
        System.out.println("Окно Google закрыто, возвращаемся на сайт.");

        // ---- ЖДЁМ КАПЧУ И КНОПКУ "ВЫСЛАТЬ КОД" ----
        ...
        String summary = "✅ *Тест v2_MOBI_social_authorization завершён успешно*\n"
