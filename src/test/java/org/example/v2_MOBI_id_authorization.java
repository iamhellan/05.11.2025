...
public class v2_MOBI_id_authorization {
    ...
    void loginAndLogout() {
        ...
        Telegram.send("🚀 *Тест v2_MOBI_id_authorization* стартовал\n(авторизация по ID + SMS)", botToken, chatId);

        String loginId = creds.getProperty("login.id");
        ...
        page.fill("input#auth_id_email", loginId);
        ...
        String summary = "✅ *Тест v2_MOBI_id_authorization завершён успешно*\n"
